...
const dim = links.immersiveManager.tags.mainSceneDimension;
const frustumMod = {};
...
frustumMod.mainSceneDimension = links.immersiveManager.tags.mainSceneDimension;
...
frustumMod.immersiveManager = tags.immersiveManager;
