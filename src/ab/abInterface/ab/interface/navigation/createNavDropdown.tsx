...
const homeWorldButton = {
    ...menuOptions,
    label: abRemember.tags.abHomeworldName ?? "homeworld",
    ...
    const placeObj = {
        ...
        onClick: `@
            if (links.place) {
                ...
                os.focusOn(links.place, { zoom: inMap ? ab.links.manifestation.tags.defaultMapPortalZoom : ab.links.manifestation.tags.defaultGridPortalZoom, rotation: {x: 45, y: 45} }).catch(e => {});
                superShout("abMenuRefresh");
            }
            `
    }
