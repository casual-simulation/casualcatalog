    ...
    for (let result of abPatchResults) {
        ...
        if (patchedBot) {
            if (result.created) {
                ...
                ab.links.utils.abLogAndToast({ message: `Cannot undo ${tags.abPatchBotIdentity}. Something went wrong during patch process? No data found to undo changes.`, logType: 'warning', space: 'shared' });
            }
        } else {
