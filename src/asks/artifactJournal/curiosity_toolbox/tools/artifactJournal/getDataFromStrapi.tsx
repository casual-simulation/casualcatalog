...
try {
    ...
    const collectablesResponse = await web.hook({
        method: 'GET',
        url: 'https://generous-eggs-66ccb5f42c.strapiapp.com/api/collectables?pagination[start]=0&pagination[limit]=1000&populate=*',
        headers:
        {
    ...
    for (let i = 0; i < collectablesResponse.data.data.length; i++) {
        ...
        if (!tags.collectableIDs[collectablesResponse.data.data[i].attributes.CollectionID]) {
            tags.collectableIDs[collectablesResponse.data.data[i].attributes.CollectionID] = [];
        }
    ...
    const artifactResponse = await web.hook({
        method: 'GET',
        url: 'https://generous-eggs-66ccb5f42c.strapiapp.com/api/artifacts?pagination[start]=0&pagination[limit]=1000',
        headers:
        {
            "Authorization": "Bearer "
        }
    ...
    const landmarkResponse = await web.hook({
        method: 'GET',
        url: 'https://generous-eggs-66ccb5f42c.strapiapp.com/api/landmarks?pagination[start]=0&pagination[limit]=1000',
        headers:
        {
            "Authorization": "Bearer "
        }
    ...
    const discoverableResponse = await web.hook({
        method: 'GET',
        url: 'https://generous-eggs-66ccb5f42c.strapiapp.com/api/discoverables?pagination[start]=0&pagination[limit]=1000',
        headers:
        {
            "Authorization": "Bearer "
        }
    ...
    const collectionsResponse = await web.hook({
        method: 'GET',
        url: 'https://generous-eggs-66ccb5f42c.strapiapp.com/api/collections?pagination[start]=0&pagination[limit]=1000',
        headers: 
        {
            "Authorization":"Bearer " 
        }
    ...
    console.log("Strapi data: ", collectablesResponse, artifactResponse, landmarkResponse, discoverableResponse, collectionsResponse)
} catch (e) {
    console.log("Error fetching Strapi data", e);
    return;
}
