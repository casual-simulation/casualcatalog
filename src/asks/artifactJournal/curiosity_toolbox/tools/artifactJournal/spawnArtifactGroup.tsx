let artifactData = that?.artifactVisualData ?? tags.artifactData;
let artifactLocationData = that?.artifactLocationData ?? tags.artifactLocationData;
let landmarkData = that?.landmarkData ?? tags.landmarkData;
let imgData = ""
let longitude = 0
let latitude = 0
...
for (let i = 0; i < landmarkData.length; i++) {
    console.log("landmark", landmarkData[i]);
    
}

for (let i = 0; i < artifactLocationData.length; i++) {
    console.log("location", artifactLocationData[i]);
}

for (let i = 0; i < artifactData.length; i++) {
    console.log("artifact", artifactData[i]);
