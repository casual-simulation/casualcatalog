if (that.tags.includes((tags.dimension ?? 'home') + 'X') || that.tags.includes((tags.dimension ?? 'home') + 'Y')) {
    if (links.spriteBot) {
        links.spriteBot.tags[(tags.dimension ?? 'home') + 'Z'] = configBot.tags.mapPortal ? tags[(tags.dimension ?? 'home') + 'Z'] + tags.scaleZ + 35 : tags[(tags.dimension ?? 'home') + 'Z'] + tags.scaleZ - 1.5;
