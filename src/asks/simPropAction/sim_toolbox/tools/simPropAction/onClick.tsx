...
const hideTriggerButton = {
    ...menuOptions,
    label: 'add a hide trigger',
    formAddress: 'add',
    simAction_menuSortOrder: 7,
    onClick: `@
        links.action.tags.choosingHideTrigger = true;
        shout("clearSimActionMenu");
    `
}

const completionTriggerButton = {
    ...menuOptions,
    label: 'add a completion trigger',
    formAddress: 'add',
    simAction_menuSortOrder: 7,
    onClick: `@
        links.action.tags.choosingCompletionTrigger = true;
        shout("clearSimActionMenu");
    `
}
...
ab.links.menu.abCreateMenuButton(completionTriggerButton);
ab.links.menu.abCreateMenuButton(hideTriggerButton);